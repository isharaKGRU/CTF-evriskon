...
<!--
var message="Access denided by admin!";
///////////////////////////////////
function clickIE4(){
if (event.button==2){
alert(message);
...
// ->
  ...
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="mis9/dashboard" class="w3-bar-item w3-button w3-theme-l1">Evrískon</a>
...
<div style="margin-top:20px"><center><h1>Mission 9</h1></center></div>
...
<a href="/mis9/download" class="w3-bar-item w3-button w3-theme-l1"">Download Now </a></br>
</div>
