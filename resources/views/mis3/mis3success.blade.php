...
<div style="margin-top:20px"><center><h1>Mission 3</h1></center></div>
<div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>

<!-- Main content: shift it to the right by 250 pixels when the sidebar is visible -->
<div class="w3-main" style="margin-left:20px;margin-bottom:50px;margin-right: 20px">
<div class="w3-main"  style="margin-left:310px;margin-bottom:50px;margin-right: 20px"> <img src="{{ URL::to('/img/mis3_2.jpg') }}"  width="460" height="auto"> </div>
