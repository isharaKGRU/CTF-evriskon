    ...
    <div class="right">
     @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('mis1/dashboard') }}" class="w3-bar-item w3-button w3-theme-l1">Dashboard</a>
                    @else
...
<div style="margin-top:20px"><center><h1>Mission 1</h1></center></div>
<div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>

<!-- Main content: shift it to the right by 250 pixels when the sidebar is visible -->
<div class="w3-main" style="margin-left:20px;margin-bottom:50px;margin-right: 20px">

<p>What you are looking for is right in front of you. You just have to dig deep.....</p>
<p>Email - mis1@evriskon.lk<br>
Password - uGZa3D8jcv9ePD8d
</p>
