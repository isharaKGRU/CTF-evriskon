    ...
    <div class="right">
     @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('mis4/dashboard') }}" class="text-sm text-gray-700 underline">Dashboard</a>
                    @else
...
<div style="margin-top:20px"><center><h1>Mission 4</h1></center></div>
<div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>

<!-- Main content: shift it to the right by 250 pixels when the sidebar is visible -->
<div class="w3-main" style="margin-left:20px;margin-bottom:50px;margin-right: 20px">

<p>What you see can be one of many pages you have access to.....</p>
<p>Email - mis4@evriskon.lk
</p>
